...
export default function Loans() {
  ...
  const openEdit = (item) => {
    ...
    setForm({
      ...
      principal_amount: item.principal_amount != null ? String(parseFloat(item.principal_amount)) : '',
      interest_rate: item.interest_rate != null ? String(parseFloat(item.interest_rate)) : '0',
